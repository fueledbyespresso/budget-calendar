...
import (
	"budget-calendar/auth/authorization"
...
// GoogleOauthConfig Create a global file oauth configuration file.
var (
...
func getSeed() int64 {
	seed := time.Now().UnixNano() // Generate a new random seed based on time
	rand.Seed(seed)
	return seed
}
